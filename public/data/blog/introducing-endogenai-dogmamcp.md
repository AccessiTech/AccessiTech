...
<!-- we need a paragraph here talking about where the human IS supposed to be in the loop, we should have plenty of lanugage about how ai should be AUGMENTIVE, not supplemental. so while the previous paragraph spoke to relying less on humans for vigilance, this new paragraph should be focused on how this frees up humans for human tasks like critical thinking and decision making, which touches on one of dogma's core axioms -->
