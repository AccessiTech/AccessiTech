...
export const VISION_P3 = "AccessiTech LLC is a social enterprise that aims to eliminate barriers for disabled design technologists and promote emergent technologies that improve digital accessibility, inclusion, and equity for all.";
