...
description: A practical guide to WCAG Guideline 1.2.6 (Sign Language, Prerecorded)—what it means, why it matters, and how to make video content accessible with sign…
keywords: wcag 1.2.6, sign language, video accessibility, web standards, digital inclusion, ASL, BSL
image: WCAG-Series-1.2.6.png
imageAlt: Blue text on yellow background saying, "Web Content Accessibility Guidelines (WCAG) 1.2.6 Explained, Sign Language (Prerecorded)"
status: published
date: 2025-07-01
...
**This guideline does NOT replace captions** ([WCAG 1.2.2](https://www.w3.org/WAI/WCAG22/quickref/#captions-prerecorded)) for deaf/hard-of-hearing users who prefer written text. Both sign language and captions may be needed to serve all users.
...
- **Inclusivity:** According to the [World Federation of the Deaf (WFD)](https://wfdeaf.org/), there are over 70 million Deaf people worldwide who use more than 300 different sign languages. In the United States, the [National Association of the Deaf (NAD)](https://www.nad.org/) reports that approximately 500,000 people use American Sign Language (ASL) as their primary language. For these individuals, **written captions are not equivalent** — sign language is their native language.
- **Educational Outcomes:** Research from [Gallaudet University](https://www.gallaudet.edu/) demonstrates that Deaf students who receive instruction in their native sign language show significantly higher literacy rates and academic achievement compared to those who rely solely on written English. Native signers process visual-spatial information differently than text, making sign language interpretation essential for full comprehension.
...
- **Cultural Recognition:** Providing sign language interpretation recognizes [Deaf culture](https://www.nad.org/) as a distinct linguistic and cultural identity, not merely a medical condition requiring accommodation.

For more, see [W3C's sign language docs](https://www.w3.org/WAI/WCAG22/Understanding/sign-language-prerecorded.html) and the [NAD's position on sign language access](https://www.nad.org/).
...
- **📢 Escalate to Decision-Makers**: Share this guide with your video production team, content creators, and accessibility leads. Make the case that true inclusion means recognizing sign language as a distinct language — not just an alternative format for captions. Reference [NAD](https://www.nad.org/) and [WFD](https://wfdeaf.org/) advocacy for sign language access.
- **📚 Learn More About Deaf Culture**: Before implementing sign language interpretation, educate your team about [Deaf culture and identity](https://www.nad.org/). Understanding that Deaf individuals form a linguistic and cultural community (not just people who "can't hear") will inform better, more respectful implementation decisions.
...
- **United States**: Use ASL certified interpreters ([RID certification](https://rid.org/))
- **United Kingdom**: Use BSL certified interpreters ([NRCPD registration](https://www.nrcpd.org.uk/))
- **Australia**: Use Auslan certified interpreters ([ASLIA accreditation](https://aslia.com.au/))
...
For technical guidance, see [Gallaudet University's video production standards](https://www.gallaudet.edu/) and [NAD's best practices](https://www.nad.org/).
...
- [ ] **Interpreter Qualifications**: Is the interpreter certified by the regional authority ([RID](https://rid.org/) for US/ASL, [NRCPD](https://www.nrcpd.org.uk/) for UK/BSL, etc.)?
...
For testing recruitment, contact [NAD local chapters](https://www.nad.org/) or [Deaf community centers](https://www.nad.org/).
...
For guidance, see [NAD's position on sign language avatars](https://www.nad.org/) and [WFD's statement on automated sign language](https://wfdeaf.org/).
...
Consult [RID's specialist certification programs](https://rid.org/) for guidance.
...
- **United States**: [Registry of Interpreters for the Deaf (RID)](https://rid.org/) certification (NIC, NIC Advanced, NIC Master, or older CI/CT credentials)
- **United Kingdom**: [National Registers of Communication Professionals with Deaf People (NRCPD)](https://www.nrcpd.org.uk/) registration (RSLI or TSLI level)
- **Australia**: [Australian Sign Language Interpreters Association (ASLIA)](https://aslia.com.au/) accreditation (Paraprofessional, Professional, or Advanced)
- **Canada**: [Association of Visual Language Interpreters of Canada (AVLIC)](https://www.avlic.ca/) certification
...
- [ ] **Ethical Standards**: Adheres to [RID Code of Professional Conduct](https://rid.org/programs/ethics/code-of-professional-conduct/) or equivalent regional ethics code
...
- **United States**: [RID Member Directory](https://myaccount.rid.org/Public/Search/Member.aspx)
- **United Kingdom**: [NRCPD Directory](https://www.nrcpd.org.uk/)
- **Australia**: [ASLIA Directory](https://aslia.com.au/)
...
For hiring guidance, see [NAD's guide to working with interpreters](https://www.nad.org/) and [RID's consumer resources](https://rid.org/).
...
- [Gallaudet University](https://www.gallaudet.edu/) — Research and education for the Deaf community
- [W3C Understanding 1.2.6](https://www.w3.org/WAI/WCAG22/Understanding/sign-language-prerecorded.html) — Official WCAG documentation
