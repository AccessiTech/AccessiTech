...
| `og:url`                | `src/App/meta.ts` | `src/pages/Blog/meta.ts` | `src/pages/Blog/wcag-meta.ts` | SSG build (ssg.config.js) ⚠️ | `src/pages/Services/*-meta.ts` | `src/pages/Services/**/*-meta.ts` | `src/pages/Products/*-meta.ts` | `src/pages/Products/*-meta.ts` | `src/App/meta.ts` | `src/pages/Disclosures/meta.ts` | `src/App/meta.ts` |
| `link[rel="canonical"]` | `src/App/meta.ts` | `src/pages/Blog/meta.ts` | `src/pages/Blog/wcag-meta.ts` | SSG build (ssg.config.js) ⚠️ | `src/pages/Services/*-meta.ts` | `src/pages/Services/**/*-meta.ts` | `src/pages/Products/*-meta.ts` | `src/pages/Products/*-meta.ts` | `src/App/meta.ts` | `src/pages/Disclosures/meta.ts` | `src/App/meta.ts` |
